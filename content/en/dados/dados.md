...
<p align="justify"> The data generated by the Access to Opportunities Project (AOP) are available for download on this website or through the R package <a href="https://ipea.github.io/aopdata/">aopdata</a>. These data bring annual estimates of access to jobs, health, education and social protection services by transport mode, as well as data on the spatial distribution of population and land use activities at a fine spatial resolution for all cities included in the project. Methodological details can be found in the <a href="https://www.ipea.gov.br/acessooportunidades/publicacoes/">annual reports of the project</a>. </p>


| R package | Data dictionary | Code |
|---|---|---|
| <a href="https://ipea.github.io/aopdata/"><img src="/acessooportunidades/img/logos/rstudio_logo.png" width="30"></a> |  [English](https://ipea.github.io/aopdata/articles/data_dic_en.html)</p> | <a href="https://github.com/ipeaGIT/acesso_oport/"><i class="fab fa-github" style="font-size: 1.5em;"></i> </a> |
